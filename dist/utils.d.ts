...
export declare function chartCreate<
...
export declare function chartUpdate<
  TType extends ChartType,
  TData = DefaultDataPoint<TType>,
  TLabel = unknown
>(chart: TypedChartJS<TType, TData, TLabel>, context?: SetupContext): void
export declare function chartDestroy<
  TType extends ChartType,
  TData = DefaultDataPoint<TType>,
  TLabel = unknown
>(chart: TypedChartJS<TType, TData, TLabel>, context?: SetupContext): void
...
export declare function setChartDatasets<
  TType extends ChartType = ChartType,
  TData = DefaultDataPoint<TType>,
  TLabel = unknown
>(
...
export declare function setChartLabels<
  TType extends ChartType,
  TData = DefaultDataPoint<TType>,
  TLabel = unknown
>(
...
export declare function setChartOptions<
  TType extends ChartType,
  TData = DefaultDataPoint<TType>,
  TLabel = unknown
>(
...
export declare function compareData<
  TType extends ChartType = ChartType,
  TData = DefaultDataPoint<TType>,
  TLabel = unknown
>(
...
export declare const templateError =
